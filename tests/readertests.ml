...
let any_version_parser_tests = [
  ...
  good_any_version_parser 3 4 Core.(Supported TLS_1_3) ;
...
let version_parser_tests = [
  ...
  good_version_parser 3 4 Core.TLS_1_3 ;
...
let good_records =
  ...
  [
    ...
    ([ 24 ; 3 ; 4 ; 0 ; 0 ], `Record (({ content_type = HEARTBEAT ; version = Supported TLS_1_3 }, empty), empty) ) ;
...
let good_client_hellos =
  ...
  Core.(let ch : client_hello =
        ...
        [
          ...
          ([1; 0; 0; 38; 3; 4] @ rand @ [(* session id *) 0; (* cipher *) 0; 0; (* comp *) 0; (* exts *)] , { ch with client_version = Supported TLS_1_3 } ) ;
          ...
          ([1; 0; 0; 50; 3; 3] @ rand @ [(* session id *) 0; (* cipher *) 0; 0; (* comp *) 0; (* exts *) 0; 10; 0; 0xA; 0; 6; 0; 4; 0; 25; 0; 20] , { ch with extensions = [`SupportedGroups Packet.([SECP521R1; SECP224K1])] } ) ;
          (* three supported groups, one unknown *)
          ([1; 0; 0; 52; 3; 3] @ rand @ [(* session id *) 0; (* cipher *) 0; 0; (* comp *) 0; (* exts *) 0; 12; 0; 0xA; 0; 8; 0; 6; 0; 25; 0xFF; 0xFF; 0; 20] , { ch with extensions = [`SupportedGroups Packet.([SECP521R1; SECP224K1])] } ) ;
...
(*           0x00; 0x23; 0x00; 0x00; (* sessionticket_tls *)
           ...
           { ch with
             ...
             extensions = [`ECPointFormats Packet.([UNCOMPRESSED; ANSIX962_COMPRESSED_PRIME; ANSIX962_COMPRESSED_CHAR2]) ;
                           `SupportedGroups Packet.([SECT571R1; SECT571K1; SECP521R1; SECT409K1; SECT409R1; SECP384R1; SECT283K1; SECT283R1; SECP256K1; SECP256R1; SECT239K1; SECT233K1; SECT233R1; SECP224K1; SECP224R1; SECT193R1; SECT193R2; SECP192K1; SECP192R1; SECT163K1; SECT163R1; SECT163R2; SECP160K1; SECP160R1; SECP160R2]);
                           `ALPN ["h2"; "http/1.1"] ] } ) ;
          ...
          ( [ 0x01; (* client hello *)
            ...
            { ch with client_version = Supported TLS_1_3 ;
