...
let group_to_impl = function
  | `FFDHE2048 -> `Nocrypto Mirage_crypto_pk.Dh.Group.ffdhe2048
  | `FFDHE3072 -> `Nocrypto Mirage_crypto_pk.Dh.Group.ffdhe3072
  | `FFDHE4096 -> `Nocrypto Mirage_crypto_pk.Dh.Group.ffdhe4096
  | `FFDHE6144 -> `Nocrypto Mirage_crypto_pk.Dh.Group.ffdhe6144
  | `FFDHE8192 -> `Nocrypto Mirage_crypto_pk.Dh.Group.ffdhe8192
  | `X25519 -> `Hacl `X25519
  | `P256 -> `Fiat `P256
